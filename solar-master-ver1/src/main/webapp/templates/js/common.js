...
$(document).ready(function () {
    var pageHtml = ["/about_us.html", "/background.html", "/introduction.html", "/organization_chart.html", "/map.html", "/mini_power_plant.html", "/diss.html", "/installation_case.html", "/service.html", "/check_list.html", "/company_info.html", "/product_info.html", "/fund.html", "/situation.html", "/situation_as.html", "/as.html", "/notice.html", "/mtm.html", "/mtm_list.html", "/qna.html", "/install_apply.html", "/install_apply_step2.html"];
    var pageTitle = ["인사말", "설립배경", "소개 및 역할", "조직도", "찾아오시는 길", "미니발전소란?", "보급목표", "설치사례", "서비스 소개", "사전 확인 사항", "보급업체 정보", "상품 정보", "보조금 정보", "진행 상황 조회", "진행 상황 조회", "AS 신청", "공지사항", "1:1문의", "1:1문의", "자주하는질문", "설치신청", "설치신청"];
...
//    });
    ...
    $('.qna-wrap').click(function () {
        var host = '../templates';
        var image_qnaqon =host+'/img/qna-on-q.png';
        var image_qnaqoff =host+'/img/qna-off-q.png';
        var image_arrow_top =host+'/img/arrow-top.png';
        var image_arrow_bottom =host+'/img/arrow-bottom.png';
        $(this).addClass('on');
        if ($(this).addClass('on')) {
        ...
        $(this).find('.qna-q').attr('src', image_qnaqon);
        $(this).siblings().find('.qna-q').attr('src', image_qnaqoff);
        $(this).find('.arrow-bottom').attr('src', image_arrow_top);
        $(this).siblings().find('.arrow-bottom').attr('src', image_arrow_bottom);
    });
    /* alert pop */
    ...
    $('.company-content-wrap-grid div button').click(function () {
         var image = $(this).closest("div").css("background-image");
        /* var imgba =image.substring(image.lastIndexOf("/") + 1,(image.length)-2);
         var path='url(../img/'+imgba+') top no-repeat'*/
        $('#logoBackgroud').css('background',image +'top no-repeat');
        var wapperHeight = $('#wrapper').outerHeight();
        $('.pop-wrap').css('height', wapperHeight);
    });
