...
<div class="content-body">
    <div class="section-main deep01 account">
        <div class="section deep01-content-wrap">
            <div class="section-content deep01-content">
                ...
                <div class="account-box-wrap">
                    ...
                    <form class="panel id-wrap" id="tab1">
                        ...
                        <div class="button-wrap">
                            <button><a href="find_account_pw.html">비밀번호 찾기</a></button>
                            <button><a href="login_01.html">로그인하기</a></button>
                        </div>
                    </form>
                    <form class="panel password-wrap" id="tab2">
                        ...
                        <input type="submit" value="비밀번호 찾기 "onClick="location.href='deep_account_02.html'">
                    </form>
                </div>
            </div>
        </div>
